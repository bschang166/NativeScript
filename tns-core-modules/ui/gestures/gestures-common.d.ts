import { GestureEventData as GestureEventData, GesturesObserver as GesturesObserverDefinition } from ".";
...
export declare module TouchAction {
    const down = "down";
    const up = "up";
    const move = "move";
    const cancel = "cancel";
...
export declare abstract class GesturesObserverBase implements GesturesObserverDefinition {
    ...
    private _context;
    type: GestureTypes;
    readonly callback: (args: GestureEventData) => void;
...
//# sourceMappingURL=gestures-common.d.ts.map