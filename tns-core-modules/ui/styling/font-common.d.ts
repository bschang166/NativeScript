...
export declare namespace FontStyle {
    const NORMAL: "normal";
    const ITALIC: "italic";
    const isValid: (value: any) => value is import("tns-core-modules/ui/styling/font").FontStyle;
    const parse: (value: any) => import("tns-core-modules/ui/styling/font").FontStyle;
}
...
export declare namespace FontWeight {
    ...
    const BLACK: "900";
    const isValid: (value: any) => value is import("tns-core-modules/ui/styling/font").FontWeight;
    const parse: (value: any) => import("tns-core-modules/ui/styling/font").FontStyle;
}
...
//# sourceMappingURL=font-common.d.ts.map